    ...
    <div>
      <form onSubmit={handleSubmit}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Button className='bg-black w-full' type='submit' variant='contained' size='large' sx={{padding:".8rem 0"}}>Registrarse</Button>
          </Grid>
      ...
      <div className='flex justify-center flex-col items-center'>
        <div className='py-3 flex items-center'>
          ...
          <Button onClick={()=>navigate("/login")} className='mal-5' size='small'>Ingresar</Button>
        </div>
      </div>
